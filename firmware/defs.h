...
#define config     (*(volatile uint32_t*)0x30000000)
// define datalength address
#define datalength (*(volatile uint32_t*)0x30000010)
// define tap address
#define taps_0    (*(volatile uint32_t*)0x30000040)
#define taps_1    (*(volatile uint32_t*)0x30000044)
#define taps_2    (*(volatile uint32_t*)0x30000048)
#define taps_3    (*(volatile uint32_t*)0x3000004c)
#define taps_4    (*(volatile uint32_t*)0x30000050)
#define taps_5    (*(volatile uint32_t*)0x30000054)
#define taps_6    (*(volatile uint32_t*)0x30000058)
#define taps_7    (*(volatile uint32_t*)0x3000005c)
#define taps_8    (*(volatile uint32_t*)0x30000060)
#define taps_9    (*(volatile uint32_t*)0x30000064)
#define taps_10    (*(volatile uint32_t*)0x30000068)
//define io address
#define d_in        (*(volatile uint32_t*)0x30000080)
#define d_out       (*(volatile uint32_t*)0x30000084)
